...
<script src="../../../resources/js/validation.js"></script> 
 <script>
            ...
            {
                // alert("hiii");
                var party_id = document.getElementById("party_typ_id");
                var name = document.getElementById("party_typ_nm");
                
                errors=[];
                checkBlank(party_id,"ID");
	...
	function checkDuplicate(param) {
		...
		var tnm="mst_party_typ";
		var fnm="party_typ_nm";
...
$("#jsGrid").jsGrid({
    ...
    fields: [
        { name: "party_typ_id", type: "text",  css: "hide"},
        { name: "party_typ_nm", type: "text", width: 50 , title: " Type"},
...
<%@include file="../common/menu.jsp" %>
 ...
 <main>
    ...
    <div class="card-header deep-orange lighten-1 white-text text-center z-depth-2">Associate Type</div>
       <div class="card-body">
         <div id="jsGrid"></div>
       </div>
       </div>
            ...
            <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <p class="heading lead">Associate Type</p>
                     ...
                     <div class="modal-body">
							...
							<tr>
							<td>ID:</td>
							<td><input type="text" name="party_typ_id" id="party_typ_id" placeholder="ID" onchange="checkDuplicate1(this.value)"></td>
							</tr>
							
							<tr>
							<td>Type:</td>
							<td><input type="text" name="party_typ_nm" id="party_typ_nm" placeholder="Type" onchange="checkDuplicate(this.value)"></td>
							</tr>
