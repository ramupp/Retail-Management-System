...
$("#jsGrid").jsGrid({
    ...
    fields: [
        { name: "price_typ",  width: 50,  css: "hide"},
        { name: "typ_nm", type: "text", width: 50, title: "Name" },
...
<%@include file="../common/menu.jsp" %>
 ...
 <main>
    ...
    <div class="card-header deep-orange lighten-1 white-text text-center z-depth-2">Payment Type</div>
       <div class="card-body">
         <div id="jsGrid"></div>
       </div>
       </div>
            ...
            <div class="modal-dialog modal-lg modal-notify modal-info" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <p class="heading lead">Payment Type</p>
                     ...
                     <div class="modal-body">
							...
							<tr>
							<td>Payment Type:</td>
							<td><input type="text" name="price_typ" id="price" placeholder="Payment Type"></td>
							</tr>
							<tr>
							<td> Name:</td>
							<td><input type="text" name="typ_nm" id="typnm" placeholder="Name" onchange="checkDuplicate(this.value)"></td>
							</tr>
