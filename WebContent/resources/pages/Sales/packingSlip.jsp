						...
						$.ajax({
									...
									success : function(data, textStatus) {
										...
										if (data=="" || data==null) {
											...
											alert("Data Has Been Saved Suceessfully with Slip No:-"+data);
											//$('#centralModalSuccess').modal();
											var x="<%=request.getContextPath()%>"+"/resources/pages/Sales/pckReport.jsp?"+"input="+data+"&input1="+$('#company_id').val();
...
<!-- 				</td> -->
                <th>
                      Date:
                        ...
                        <td colspan="1">
                          <input placeholder="Selected date" type="text" name="pck_sl_dt" id="pck_sl_dt" style=" width: 120px" value="<%=trdate %>" class="form-control datepicker">
                        ...
                        <th>
                         ...
                         <select name="party_id" id="party_id" class="browser-default" onchange="getConsignee(this.value)">
                          <%
       String mnpo= util.getDropdownStringForPckSlipWithSDtype("mst_party", "party_id","party_nm");
        out.println(mnpo);
        %> 
                        </select>
                            </td>
...
<input type="text" name="desg_id[]" id="desg_id" style=" width: 100px" class="desgClass" onchange="fetchItemTypeAndItemForDesign(this,<%=coid %>,'CR');  " />
                  ...
                  <td style=" width: 50px; display:none"><input type="text" name="qty[]" id="qty"  value='0' />
                    <input type="text" name="stk[]" id="stk"  value='0' />
                     ...
                     <%
                           ...
                           %>
                    <td><input type="text" name="nuom_id[]" id="<%=rsnew.getString("uom_nm")%>" onkeyup="checkMinus(this.value,this);" onchange="getGstValues(this);putUomData(this.id,this,this.value,'<%=sid%>');" class="cleanData" style="width:70px;text-align:right;"/>
