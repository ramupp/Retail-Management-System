...
;(function ($, window, undefined)
{
    ...
    function renderActions()
    {
        if (this.options.navigation !== 0)
        {
            ...
            if (actionItems.length > 0)
            {
                ...
                // Row count selection
                this.renderRowCountSelection.call(this, actions);
    ...
    var Grid = function(element, options)
    {
        ...
        this.rowCount = ($.isArray(rowCount)) ? rowCount[element] : rowCount;
        this.rows = [];
        this.searchPhrase = "";
        this.selectedRows = [];
        this.sortDictionary = {};
    ...
    Grid.defaults = {
        ...
        rowCount: [5, 25, 50, -1], // rows per page int or array of int (-1 represents "All")
