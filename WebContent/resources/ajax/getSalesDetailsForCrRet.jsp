...
<!--                         </th> -->
<!--                         <td colspan="1"> -->
                          <input type="hidden" name="pck_sl_no" id="pck_sl_no" class="form-control" value="<%=pck_sl_no%>">
...
<!--                             </td> -->
    		...
    		%>
                  ...
                  %>  
                    <tr id="cloneRow">
                  <td><input type="text" name="barcode[]" id="barcode" style=" width: 80px" value='<%=rsp.getString("barcode")%>' class="pivotElement"/></td>
...
<!--                     <td><input type="text" name="qty[]" id="qty" style=" width: 50px"  /></td> -->
                                        <td><input type="text" name="qty1[]" id="qty1" style=" width: 50px;text-align:right" onfocus="calqtydiff(this.value,this);" value='<%=rsp.getString("qty")%>' class="qtyClass" readonly/>
                    <td><input type="text" name="qty[]" id="qty" style=" width: 50px;text-align:right" onkeyup="qtyValidate(this.value,this);" onchange="" class="rqtyClass" />
                    ...
                    <td><input type="text" name="gst_per[]" id="gst_per" style=" width: 50px; text-align:right" value='<%=rsp.getString("gst_per")%>' onchange="afterRateChangeReturn(this)" readonly/></td>
